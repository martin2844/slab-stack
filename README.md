...
[`releases/v0.1.0-candidate.8.json`](releases/v0.1.0-candidate.8.json). It pins
...
```bash
node scripts/render-image-env.mjs releases/v0.1.0-candidate.8.json
```
...
```bash
./scripts/package-release.sh releases/v0.1.0-candidate.8.json dist
```
...
```bash
sudo sh install.sh --version 0.1.0-candidate.8
```
...
```bash
sudo sh install.sh --version 0.1.0-candidate.8 -- --dry-run
```
