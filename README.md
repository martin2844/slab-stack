...
[`releases/v0.1.2-candidate.30.json`](releases/v0.1.2-candidate.30.json). Both pin
...
```bash
node scripts/render-image-env.mjs releases/v0.1.2-candidate.30.json
```
...
```bash
./scripts/package-release.sh releases/v0.1.2-candidate.30.json dist
```
...
```bash
sudo sh install.sh --version 0.1.2-candidate.30
```
...
```bash
sudo sh install.sh --version 0.1.2-candidate.30 -- --dry-run
```
