...
```bash
node scripts/render-image-env.mjs releases/v0.1.0-candidate.19.json
```
...
```bash
./scripts/package-release.sh releases/v0.1.0-candidate.19.json dist
```
...
```bash
sudo sh install.sh --version 0.1.0-candidate.19 -- --dry-run
```
