...
[`releases/v0.1.0-candidate.14.json`](releases/v0.1.0-candidate.14.json). It pins
...
```bash
node scripts/render-image-env.mjs releases/v0.1.0-candidate.14.json
```
...
```bash
./scripts/package-release.sh releases/v0.1.0-candidate.14.json dist
```
...
```bash
sudo sh install.sh --version 0.1.0-candidate.14
```
...
```bash
sudo sh install.sh --version 0.1.0-candidate.14 -- --dry-run
```
