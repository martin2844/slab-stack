...
[`releases/v0.1.0-candidate.17.json`](releases/v0.1.0-candidate.17.json). It pins
...
```bash
node scripts/render-image-env.mjs releases/v0.1.0-candidate.17.json
```
...
```bash
./scripts/package-release.sh releases/v0.1.0-candidate.17.json dist
```
...
```bash
sudo sh install.sh --version 0.1.0-candidate.17
```
...
```bash
sudo sh install.sh --version 0.1.0-candidate.17 -- --dry-run
```
