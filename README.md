...
[`releases/v0.1.2-candidate.43.json`](releases/v0.1.2-candidate.43.json). Both pin
...
```bash
node scripts/render-image-env.mjs releases/v0.1.2-candidate.43.json
```
...
```bash
./scripts/package-release.sh releases/v0.1.2-candidate.43.json dist
```
...
```bash
sudo sh install.sh --version 0.1.2-candidate.43
```
...
```bash
sudo sh install.sh --version 0.1.2-candidate.43 -- --dry-run
```
